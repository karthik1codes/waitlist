  ...
  return (
    <div className="gibson-container">
      <div className="gibson-main">
        ...
        <div className="gibson-content">
          <h1 className="gibson-headline">
            Where Accessibility Meets Ability.
          </h1>
        ...
        <div className="gibson-footer">
          <div className="gibson-footer-links">
            <button 
              onClick={() => setShowTerms(true)} 
              className="gibson-footer-link"
            >
              Terms
            </button>
            <button 
          ...
          <a 
            ...
            className="gibson-instagram-link"
          >
            <span className="instagram-text">Follow and Stay Tuned</span>
            <svg 
      ...
      <ContentPolicyModal isOpen={showContentPolicy} onClose={() => setShowContentPolicy(false)} />
    </div>
  );
};

export default memo(GibsonLayout);
